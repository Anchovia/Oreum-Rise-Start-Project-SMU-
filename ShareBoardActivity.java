        ...
        // 상단바 코드 부분
        {
            ...
            button_gotoSetting.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(ShareBoardActivity.this, SettingActivity.class);
            ...
            button_gotoMyInfo.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(ShareBoardActivity.this, MyInfoActivity.class);
                    startActivity(intent);
                }
            });
        }
        ...
        // 하단바 코드 부분
        {
            ...
            Button_gotoHome.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(ShareBoardActivity.this, MainActivity.class);
                    startActivity(intent);
                }
            });
        }
